...
begin
	case(INSTRUCTION[6:0])
		`R_type: begin jal=0;Branch=0;Imm_gen=3'b111;RegScr=1'b0;ALUop=3'b000;MemWrite=0;ALUctr2=0;RegWrite=1; MemWread=0;end
		`addi: begin jal=0;Branch=0;Imm_gen=`I_type;RegScr=1'b0;ALUop=3'b000;MemWrite=0;ALUctr2=1;RegWrite=1; MemWread=0;end
